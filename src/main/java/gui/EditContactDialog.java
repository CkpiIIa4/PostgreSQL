...
public class EditContactDialog extends JDialog implements ActionListener {
    ...
    private void buildFields() {
        JLabel lblFirstName = new JLabel(GuiResources.getProperty(DIALOG + C_GIVEN) + ":");
        ...
        JLabel lblLastName = new JLabel(GuiResources.getProperty(DIALOG + C_SURNAME) + ":");
        ...
        JLabel lblPhone = new JLabel(GuiResources.getProperty(DIALOG + C_PHONE) + ":");
        ...
        JLabel lblEmail = new JLabel(GuiResources.getProperty(DIALOG + C_EMAIL) + ":");
